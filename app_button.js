...
function createGIF () {
  ...
  shell.exec(shell_string_ffmpeg_palette, function(code, output) {
    ...
    var shell_string_ffmpeg_gif = "ffmpeg -ss 1 -i " + target_file_h264 + " -i " + target_file_palette + " -lavfi 'fps=15,scale=320:-1:flags=lanczos [x]; [x][1:v] paletteuse' -y " + target_folder_gif_path + target_file_gif;
